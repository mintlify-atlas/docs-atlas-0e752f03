...
<Steps>
  ...
  <Step title="Install AppImage">
    Download the AppImage from [GitHub releases](https://github.com/khcrysalis/PlumeImpactor/releases):
  ...
  <Step title="Install binary directly">
    ...
    wget https://github.com/khcrysalis/PlumeImpactor/releases/latest/download/Impactor-linux-x86_64
